...
(define (problem C3_2)
  ...
  (:objects
   ...
   ;; ADDITION
   train2 train3                                ;; two trains in city2 and city3
   train_station1 train_station2 train_station3 ;; one train station in each city
   )
  (:init
   ;; Type declarations:
   ...
   ;;ADDITION: Defining trains as "vehicle" and as their subtype "train"
   ...
   ;;ADDITION: Defining train stations as "location" and as their subtype "train_station"
   (location train_station1) (location train_station2) (location train_station3)
   (train_station train_station1) (train_station train_station2) (train_station train_station3)
   ...
   ;; ADDITION: Locating train stations to their respective cities
   (loc train_station1 city1) (loc train_station2 city2) (loc train_station3 city3)
   ...
   ;; ADDITION: Locating the trains to their respective stations
   (at train2 train_station2)
   (at train3 train_station3)
   )
