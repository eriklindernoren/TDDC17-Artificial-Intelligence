...
public class QLearningController extends Controller {
	...
	public void tick(int currentTime) {
		...
		if (!paused) {
			...
			// Will make random explorations less likely as the agent gets
			// smarter.
			...
			if (previous_state != null) {
				...
				double _alpha = alpha(Ntable.get(prev_stateaction));
				double update = _alpha*(previous_reward + GAMMA_DISCOUNT_FACTOR*getMaxActionQValue(new_state) - Qtable.get(prev_stateaction));
				double newQ = Qtable.get(prev_stateaction) + update;
